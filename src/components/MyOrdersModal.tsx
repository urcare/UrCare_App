        ...
        <div className="flex items-center justify-between pb-4 border-b border-zinc-800 shrink-0">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-zinc-400">Track and manage your nutrition & supplement orders</p>
            </div>
          </div>
          <button
            type="button"
          ...
          {orders.length === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="text-xs text-zinc-400 mt-1 max-w-xs mx-auto">
                Explore our scientifically formulated supplements, whey protein, and superfoods in the store.
              </p>
              {onOpenStore && (
                <button
                  type="button"
              ...
              >
                ...
                {order.receiptUrl && (
                  <div className="p-2.5 rounded-xl bg-zinc-950 border border-zinc-800 text-xs flex items-center justify-between">
                    <span className="text-zinc-400 text-[11px]">Payment Receipt Uploaded</span>
                    <a
                    ...
                    <div key={idx} className="flex items-center justify-between text-xs py-1 border-t border-zinc-800/60 pt-2">
                      <div className="flex items-center gap-2.5">
                        ...
                        <div>
                          ...
                          <div className="text-[11px] text-zinc-400">Qty: {item.quantity} × ₹{item.product.discountPrice || item.product.price}</div>
                        </div>
                      </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2 border-t border-zinc-800 text-xs">
                  ...
                  <div className="flex items-center sm:justify-end gap-2 text-zinc-400">
                    ...
                    <span>Est. Delivery: <strong className="text-emerald-300">{order.estimatedDelivery}</strong></span>
                  </div>
                </div>
              </div>
            ))
